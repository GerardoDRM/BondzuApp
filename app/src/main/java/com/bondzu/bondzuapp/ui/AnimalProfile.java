...
import com.bondzu.bondzuapp.adapters.ViewPagerAdapter;
import com.bondzu.bondzuapp.view.FragmentDrawer;
import com.bondzu.bondzuapp.view.SlidingTabLayout;

public class AnimalProfile extends AppCompatActivity implements FragmentDrawer.FragmentDrawerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence titles[] = {getString(R.string.about_title), getString(R.string.community_title),
                getString(R.string.gallery_title), getString(R.string.gifts_title)};
        Titles = titles;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_animal_profile, menu);
        return true;
    }
