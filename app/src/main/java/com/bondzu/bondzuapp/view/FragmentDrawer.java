...
import com.bondzu.bondzuapp.adapters.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imgs = getActivity().getResources().obtainTypedArray(R.array.nav_drawer_imgs);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(photo == null){
            ...
            if(file != null)
                ...
                photo = GeneralConstants.KEY_DEFAULT_PHOTO_URL;
        }
